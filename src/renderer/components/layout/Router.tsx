...
const LocalAgentSettings = React.lazy(() => import('@renderer/pages/settings/LocalAgentSettings'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/local-agent/:backend' element={withRouteFallback(LocalAgentSettings)} />
